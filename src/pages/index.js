...

		{
                ...
                <TextLoop springConfig={{ stiffness: 180, damping: 12, fade: true }}>
                    ...
                    <span>வணக்கம்</span>
						...
						<p style={{textAlign:"left"}}>I design touchpoint for user & customer. I can also map revenue & user workflows with my business background and solve problems with various technical knowledge like <h1 className="aside__h1">Javascript ES6, React.js, Analytics, Git & Python.</h1> <br/>I started my journey <h1 className="aside__h1">studying business</h1> which enabled me to fully understand the perspective of business and my passion for <h1 className="aside__h1">gaming for over 10 years</h1> helped me understand the user and led me to become tech-savvy</p>
